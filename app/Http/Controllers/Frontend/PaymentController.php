                    ...
                    if (auth()->user()->email) {
                        Mail::raw('New Order placed.', function ($message) use ($pdf) {
                            $message->to(auth()->user()->email)
                             ->from('info@canntumemporium.com', 'Canntum Emporium') 
                                ->subject('Your Order Invoice - Canntum Emporium')
                                ->replyTo('info@canntumemporium.com', 'Support')
                ...
                try {
                    Mail::raw('A new order has been placed.', function ($message) {
                        $message->to('canntumemporium@gmail.com')
                            ->subject('New Order Success - Canntum Emporium');
                    });
                } catch (\Exception $e) {
