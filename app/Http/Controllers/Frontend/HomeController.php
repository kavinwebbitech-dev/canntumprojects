...
class HomeController extends Controller
{
    ...
    //     // Session::flush();
    //     if (($request->size != '' && $request->size != null) && ($request->color != '' && $request->color != null)) {
    //         $productDetails = ProductDetail::where('product_id', $id)->where('size', $request->size)->where('color', $request->color)->first();
    ...
    //         // Get product detail based on color and size
    //         $productDetail = null;
    ...
    //         $productImages  = Upload::where('product_id', $productDetails->product_id)->get();

    //         $colorIds = ProductDetail::where('product_id', $productDetails->product_id)->distinct()->pluck('color');

    //         $colors = Color::whereIn('id', $colorIds)->get();

    //         $sizeIds = ProductDetail::where('product_id',  $productDetails->product_id)->where('color', $request->color)->distinct()->pluck('size');

    //         $sizes = Size::whereIn('id', $sizeIds)->get();
    //     } else if ($request->color != '' && $request->color != null) {
    //         $productDetails = ProductDetail::where('product_id', $id)->where('color', $request->color)->first();
    ...
    //         $sizes = Size::whereIn('id', $sizeIds)->get();
    //     } else if ($request->size != '' && $request->size != null) {
    //         $productDetails = ProductDetail::where('product_id', $id)->where('size', $request->size)->first();

    //         $product        = Product::where('deleted', 0)->where('id', $productDetails->product_id)->first();
    ...
    //         $sizeIds = ProductDetail::where('product_id',  $productDetails->product_id)->distinct()->pluck('size');
    ...
    //         $colorIds = ProductDetail::where('product_id', $id)->distinct()->pluck('color');

    //         $colors = Color::whereIn('id', $colorIds)->get();

    //         $sizeIds = ProductDetail::where('product_id', $id)->distinct()->pluck('size');

    //         // $sizes = Size::whereIn('id', $sizeIds)->get();
    //     }

    //     return view('frontend.product.details', compact('productDetails', 'productImages', 'product'));
    // }
    ...
    //     // ====================================================
    //     // STEP 4: Load variant detail for COLOR + SIZE combo
    //     // ====================================================
    //     $productDetail = null;
    //     if ($colorId && $sizeId) {
    //         $productDetail = ProductDetail::where('product_id', $id)
    ...
    //     return view('frontend.product.details', compact(
    //         'product',
    //         'galleryImages',      // ← Fallback images
    //         'productDetail',      // ← Variant with images
    //         'colors',             // ← All colors
    //         'sizes',              // ← Sizes for selected color
    //         'colorId',            // ← Selected/default color
    //         'sizeId'              // ← Selected/default size
    //     ));
    // }
    public function productDetails($id, Request $request)
    {
