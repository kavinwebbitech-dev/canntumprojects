...
<button type="button" class="btn" style=" background-color: #001E40 !important;color:#fff" onclick="window.location.href = '{{ route('admin.product.category.add') }}'">
  Add New
</button>
                ...
                <tr>
                    ...
                    <td>
						<div class="d-flex">
                            ...
                            <a href="{{ route('product.category.delete',$item->id) }}" class="btn btn-danger shadow btn-xs sharp "><i class="fa fa-trash"></i></a>
						</div>
					</td>
                </tr>
                @endforeach
