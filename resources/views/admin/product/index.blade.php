        ...
        <table id="" class="export-table display table table-bordered verticle-middle table-striped table-responsive-sm" style="min-width: 845px">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $key+1 }}</td>
                    <td>
                        <img src="{{ asset('public/product_images/' . $item->product_img) }}" style="width:60px" alt="Product Image">
                        {{ $item->product_name }}
                    </td>
                    <td>
                    ...
                    <td>
						<div class="d-flex">
							<a href="{{ route('product.edit',$item->id) }}" class="btn btn-success shadow btn-xs sharp me-2"><i class="fas fa-pencil-alt"></i></a>
