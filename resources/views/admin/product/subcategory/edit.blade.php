...
<div class="profile-tab">
    <div class="custom-tab-1">
        <ul class="nav nav-tabs">
            <li class="nav-item"><a href="#profile-settings" data-bs-toggle="tab" class="nav-link active show">PRODUCT SUBCATEGORY</a>
            </li>
        </ul>
            ...
            <div id="profile-settings" class="tab-pane fade active show">
                <div class="pt-3">
                    <div class="settings-form">
                            <form method="POST" action="{{ route('admin.product.subcategory.update') }}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="subcategory_id" class="form-control" value="{{ $subcategory->id }}">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Category</label>
                                        <select class="default-select form-control wide" id="category" name="category_id" required>
...
$(document).ready(function(){
  ...
  $('.crop_image').click(function(event){
    ...
    $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{ route('crop-image-upload-ajax-subcat') }}",
