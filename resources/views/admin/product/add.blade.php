...
@section('admin')
                    ...
                    <div class="pt-3">
                        <div class="settings-form">
                            <form method="POST" action="{{ route('admin.product.store') }}" enctype="multipart/form-data"
                                ...
                                <div id="variantRequiredMsg">⚠ Please add at least one product variant before submitting.
                                </div>
    ...
    {{-- <script>
        ...
        $(document).ready(function() {
            ...
            // Image upload preview for variant main images
            ...
            // Image upload preview for variant gallery images
            $(document).on('change', '.variant-gallery-images', function() {
                const files = this.files;
                const container = $(this).closest('td').find('.gallery-preview-container');

                if (files.length > 4) {
                    alert('Maximum 4 gallery images allowed per variant');
                    this.value = '';
                    return;
                }
        ...
        // Add Variant Row Function — now includes Quantity and Gallery Images columns
        ...
        <tr data-color="${colorId}" data-size="${sizeId}" id="${rowId}">
            ...
            <td>
                <input type="file" name="variants[${variantCounter}][gallery_images][]" class="form-control variant-gallery-images" accept="image/*">
                <small class="text-muted">Max 4 gallery images</small>
                <div class="gallery-preview-container gallery-preview mt-2"></div>
            </td>
