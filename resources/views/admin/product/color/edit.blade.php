            ...
            <div id="profile-settings" class="tab-pane fade active show">
                <div class="pt-3">
                    <div class="settings-form">
                            <form method="POST" action="{{ route('admin.product.color.update') }}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="coupon_id" class="form-control" value="{{ $color_code->id }}">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Color</label>
                                        <input type="text" name="color" class="form-control" placeholder='color' value="{{ $color_code->color }}">
                                    </div>
                                    <div class="mb-3 col-md-6">
                                       <label class="form-label">Code - Hex Code</label>
                                        <input type="text" name="code" class="form-control" placeholder="eg:#FF5733" value="{{ $color_code->code }}">
                                    </div>
                                </div>
                                <br>
