...
<button type="button" class="btn" style=" background-color: #001E40 !important;color:#fff" onclick="window.location.href = '{{ route('admin.product.gallery.add') }}'">
  Add New
</button>
        ...
        <table id="example4" class="display table table-bordered verticle-middle table-striped table-responsive-sm" style="min-width: 845px">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
						<div class="d-flex">
							<a href="{{ route('admin.product.gallery.edit',$item->id) }}" class="btn btn-success shadow btn-xs sharp me-2"><i class="fas fa-pencil-alt"></i></a>
                            <a href="{{ route('product.gallery.delete',$item->id) }}" class="btn btn-danger shadow btn-xs sharp "><i class="fa fa-trash"></i></a>
						</div>
					</td>
                </tr>
                @endforeach
