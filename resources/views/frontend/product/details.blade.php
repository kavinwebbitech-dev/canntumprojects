                    ...
                    <div class="image-gallery">
                        ...
                        @elseif ($galleryImages->count() > 0)
                            <div class="row gy-4 gx-2">
                                ...
                                <div class="col-lg-9 col-md-9 order-0 order-md-1">
                                    <div class="big-img">
                                        <main class="primary" style="background-image: url('{{ url('public/' . $galleryImages[0]->path) }}');"></main>
                                    </div>
                                </div>
                            </div>
                        ...
                        @else
                            <div class="row gy-4 gx-2">
                                <div class="col-lg-12">
                                    <div class="big-img">
                                        <main class="primary" style="background-image: url('{{ url('public/' . $product->product_img) }}');"></main>
                                    </div>
                                </div>
                            </div>
                        @endif
                ...
                <div class="col-lg-6">
                    ...
                    @endforeach
                        ...
                        <div class="mt-4" style="max-width: 450px;">
                            @if ($productDetail)
                                @if ($productDetail->quantity > 0 && !empty($productDetail->images))
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="flex-grow-1">
                                            <a href="javascript:void(0);" data-product-id="{{ $productDetail->id }}"
                                                id="add-cart-btnn-{{ $productDetail->id }}"
                                                class="btn cart_btn add-to-cart-btn w-100 mb-2">
                                                Add to Cart <i class="bi bi-cart2 ms-2"></i>
                                            </a>
                                            <a href="javascript:void(0);" data-product-id="{{ $productDetail->id }}"
                                                id="adding-cart-{{ $productDetail->id }}"
                                                style="display: none" class="btn green-btn w-100 mb-2">
                                                <i class="fas fa-shopping-cart"></i> Added
                                            </a>
                                            <a href="javascript:void(0);" data-product-id="{{ $productDetail->id }}"
                                                id="buy-now-{{ $productDetail->id }}"
                                                class="btn book_btn buy-now-btn w-100">Buy Now
                                            </a>
                                        </div>
                                        <div class="d-flex flex-column justify-content-center align-items-center" style="margin-left: 30px;">
                                            <a href="javascript:void(0);" data-product-id="{{ $product->id }}"
                                                ...
                                                <i class="bi bi-heart-fill" style="cursor:pointer; font-size:22px;"></i>
                                            </a>
                                ...
                                @elseif ($productDetail->quantity == 0)
                                    {{-- Variant exists but quantity is 0 — show Out of Stock for this variant --}}
                                    
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="flex-grow-1">
                                            <div class="alert alert-warning mb-2"style="width: 365px;border-radius: 0px;font-size: 16px;display: flex;justify-content: center;align-items: center;"><strong class="text-center">Out of Stock</strong></div>
                                            <button class="btn cart_btn w-100 mb-2" hidden style="opacity:0.5;cursor:not-allowed;">
                                                Add to Cart <i class="bi bi-cart2 ms-2"></i>
                                            </button>
                                            <button class="btn book_btn w-100" hidden style="opacity:0.5;cursor:not-allowed;">
                                                Buy Now
                                            </button>
                                        </div>
                                        <div class="d-flex flex-column justify-content-center align-items-center" style="margin-left: 30px;">
                                ...
                                @else
                                    <div class="alert alert-warning"><strong>Out of Stock</strong></div>
                                @endif
                            @else
                                <div class="alert alert-warning"><strong>Out of Stock</strong></div>
                            @endif
