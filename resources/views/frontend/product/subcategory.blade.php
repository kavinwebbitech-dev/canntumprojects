...
@section('content')
    ...
    <style>
        ...
        a {
            --bs-link-color: #001E40 !important;
        }
    ...
    <section class="product_list">
        @php
            $subcatname = App\Models\ProductSubCategory::where('id', $sub_cat_id)->first();
            $catname = App\Models\ProductCategory::where('id', $subcatname->category_id)->first();
        @endphp
            ...
            <div class="filter_box">
                <form id="sort-form" action="" method="GET">
                    <div class="row gy-4 align-items-center">
                        <div class="col-lg-6">
                            <h1 class="product_title">{{ $subcatname->name }}</h1>
                        </div>
                        <div class="col-lg-6">
                            <div class="row gx-2 gy-3">
                                <div class="col-lg-8 col-md-4 col-6"></div>
                            </div>
                        </div>
                    </div>
                </form>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-6">
                                                        @php
                                                            ...
                                                            $discountedPrice = 0;
                                                            if ($product_price && $product_price->price) {
                                                                $discountedPrice =
                                                                    $product_price->price -
                                                        ...
                                                        <p class="text-end">
                                                            ...
                                                            @else
                                                                <div class="out-of-stock text-center">
                                                                    <a class="cart-btn"
                                                                        style="background: white; color: #272727;border: 1px solid #272727; font-size:12px !important; padding:7px 6px">Out
                                                                        of
                                                                        stock</a>
                                                                </div>
                                                            @endif
                            ...
                            @else
                                <div class="col-12">
                                    <div class="empty-products">
                                        ...
                                        <p>There are no products available in this subcategory yet.</p>
